...
const en = {
  ...
  adminAnnouncements: {
    ...
    bodyPlaceholder: "Message",
    linkUrlPlaceholder: "Link URL (optional)",
    linkLabelPlaceholder: "Link text (optional)",
    priorityLabel: "Priority",
    priorityCritical: "Critical (max 1 shown)",
    priorityGeneral: "General (max 5 shown)",
    audienceLabel: "Audience",
    audienceUsers: "Users (site-wide)",
    audienceAdmins: "Admins (/admin only)",
...
const th: typeof en = {
  ...
  adminAnnouncements: {
    ...
    bodyPlaceholder: "เนื้อหา",
    linkUrlPlaceholder: "ลิงก์ (ไม่บังคับ)",
    linkLabelPlaceholder: "ข้อความลิงก์ (ไม่บังคับ)",
    priorityLabel: "ระดับความสำคัญ",
    priorityCritical: "สำคัญที่สุด (โชว์สูงสุด 1 อัน)",
    priorityGeneral: "ทั่วไป (โชว์สูงสุด 5 อัน)",
    audienceLabel: "กลุ่มเป้าหมาย",
    audienceUsers: "ผู้ใช้งาน (แสดงทั้งเว็บ)",
    audienceAdmins: "แอดมิน (เฉพาะหน้า /admin)",
    publishAtLabel: "วันเริ่มเผยแพร่",
    expiresAtLabel: "วันหมดอายุ",
    expiresAtHint: "เว้นว่างไว้ = ไม่หมดอายุ",
    activeLabel: "เปิดใช้งาน",
    createButton: "สร้างประกาศ",
    updateButton: "บันทึกการแก้ไข",
    cancelEditButton: "ยกเลิก",
    editButton: "แก้ไข",
    deleteButton: "ลบ",
    activateButton: "เปิดใช้งาน",
    deactivateButton: "ปิดใช้งาน",
    listEmpty: "ยังไม่มีประกาศข่าว",
    statusActive: "กำลังแสดง",
    statusInactive: "ปิดใช้งาน",
    statusExpired: "หมดอายุแล้ว",
    statusScheduled: "รอเผยแพร่",
    saved: "บันทึกประกาศแล้ว",
    failedToLoad: "โหลดประกาศไม่สำเร็จ",
    failedToSave: "บันทึกประกาศไม่สำเร็จ",
